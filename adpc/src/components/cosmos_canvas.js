/**
 * @param {String} id  id
 * @param {String} starscolor  星星颜色
 * @param {Number} starsamount 星星数量
 * @param {Number} starsradius 星星半径比
 * @param {Number} movrange 星星移动范围
 * @param {Number} speed  星星速度
 * @param {Number} trailing 拖尾
 */
